...
# Project 1 : Data Modeling with Postrgres (_ajouter un log_)
here some fews words to describe the projetc, beginning by a verb transitif

### Table of contents(_a completer)
...
pour les causes d'exclusion 
    unique et ... ==> primary key
    donc INSRT INTO UPDATE SET =excluted
    https://stackoverflow.com/questions/35159431/on-conflict-do-update-has-missing-from-clause

readme  
[ ] faire une ligne grise sous chaque titre ### et qui traverse la page  
